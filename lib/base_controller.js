...
var base_controller = function() {
  ...
  this.render = function(res, vars, layout) {
    ...
    var layout = this.layout || jails.layouts["app"];
  ...
  this.redirect = function(res, controller_name, action_name) {
    ...
    jails.controllers[controller_name][action_name](res);
  };
};

module.exports = new base_controller();
